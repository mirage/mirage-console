...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1048c6ba34c2b737b2e73fd9f3a86ded) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Library
                 ({
                     cs_name = "mirage_console_protocol";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mirage_console_protocol";
                           FindlibPackage ("xenstore", None);
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\238\219\217\028\142\154`\012\242Q\151MkY\135\000";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
