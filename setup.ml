...
(* OASIS_START *)
(* DO NOT EDIT (digest: 862fef3eac22c79d3f6fbee54e15efbc) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "true to depend on Unix xenctrl libraries";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "mirage-console";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "mirage-console"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Conproto"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage-console";
                      lib_findlib_name = Some "proto";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("xenstore", None);
                           InternalLibrary "mirage_console_proto";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\150\b1ä#\006Îà§\003üªDëH\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
